...
const Login = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // Also support the hardcoded admin fallback
    const isAdminFallback = formData.email === 'admin@gmail.com' && formData.password === '123456';
    
    if (userFound || isAdminFallback) {
      ...
      <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-2xl shadow-xl border border-gray-100">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600">
            Sign in to access the Smart Crop Analyser
          </p>
        </div>
